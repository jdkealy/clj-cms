...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14016 = 0;while(true){
if((i_14016 < arr.length))
{(arr[i_14016] = null);
{
...
{var i_14023 = (self__.level + 1);while(true){
if((i_14023 <= (new_level + 1)))
{(update[i_14023] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14025 = 0;while(true){
if((i_14025 <= self__.level))
{var links_14026 = (update[i_14025]).forward;if(((links_14026[i_14025]) === x__$1))
{(links_14026[i_14025] = (x__$1.forward[i_14025]));
{
var G__14027 = (i_14025 + 1);
i_14025 = G__14027;
continue;
}
} else
{{
var G__14028 = (i_14025 + 1);
i_14025 = G__14028;
continue;
}
}

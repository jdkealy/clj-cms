...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14057 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14057 = (function (val,box,meta14058){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14057.cljs$lang$type = true;
cljs.core.async.impl.channels.t14057.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14057";
cljs.core.async.impl.channels.t14057.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"cljs.core.async.impl.channels/t14057");
});
cljs.core.async.impl.channels.t14057.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14057.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14059){var self__ = this;
var _14059__$1 = this;return self__.meta14058;
});
cljs.core.async.impl.channels.t14057.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14059,meta14058__$1){var self__ = this;
var _14059__$1 = this;return (new cljs.core.async.impl.channels.t14057(self__.val,self__.box,meta14058__$1));
});
cljs.core.async.impl.channels.__GT_t14057 = (function __GT_t14057(val__$1,box__$1,meta14058){return (new cljs.core.async.impl.channels.t14057(val__$1,box__$1,meta14058));
});
}
return (new cljs.core.async.impl.channels.t14057(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14060 = self__.takes.pop();if((taker_14060 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14060))
{var take_cb_14061 = cljs.core.async.impl.protocols.commit.call(null,taker_14060);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14061,taker_14060){
return (function (){return take_cb_14061.call(null,null);
});})(take_cb_14061,taker_14060))
);
} else
{}
{

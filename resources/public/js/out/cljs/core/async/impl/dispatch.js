...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14051 = 0;while(true){
var m_14052 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14052 == null))
{} else
{m_14052.call(null);
if((count_14051 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14053 = (count_14051 + 1);
count_14051 = G__14053;
continue;
}
} else
{}

...
{{
var G__10930 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10930;
continue;
}
} else
...
{var pred__10934 = cljs.core._EQ_;var expr__10935 = limit;if(cljs.core.truth_(pred__10934.call(null,1,expr__10935)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10934.call(null,2,expr__10935)))
...
var G__10937 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10938 = (limit__$1 - 1);
var G__10939 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10937;
limit__$1 = G__10938;
parts = G__10939;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10941 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10941))
{var replacement_10942 = temp__4090__auto___10941;buffer.append([cljs.core.str(replacement_10942)].join(''));
} else
{buffer.append(ch);
}
{
